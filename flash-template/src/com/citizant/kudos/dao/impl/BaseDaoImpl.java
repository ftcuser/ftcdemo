...
import com.citizant.kudos.dao.BaseDao;
...
public class BaseDaoImpl implements BaseDao {
	...
	public BaseDaoImpl(){
        ...
        dynamoDB.setRegion(SystemConfig.getInstance().getAWSRegion());
        //dynamoDB.setRegion(Region.getRegion(Regions.US_WEST_1));
